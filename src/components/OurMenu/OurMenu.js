        ...
        <div id='contents' className='py-[100px]'>
            <div className='w-full m-auto'>
                <div className='w-4/5 xl:w-1/2 m-auto text-center'>
                    ...
                    <p className='text-[14px] md:text-[16px] leading-[25px]'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از و مجله در ستون و سطرآنچنان ستون و سطرآنچنان ستون و سطرآنچنان که لازم است</p>
                </div>
