    ...
    return (
        <div className='bg-[#232323] text-white-0 py-[50px]'>
            <div className='w-4/5 m-auto flex flex-col justify-between items-start lg:items-center lg:flex-row-reverse'>
                <div className='flex flex-1 flex-col items-center text-white-0'>
                ...
                <div className='w-full flex-[3_3_0] my-[30px] lg:mx-[50px] font-Vazir-regular lg:my-0'>
                ...
                <div className='font-Vazir-regular flex-1'>
